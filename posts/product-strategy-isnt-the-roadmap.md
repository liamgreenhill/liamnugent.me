---
title: The product strategy isn’t the roadmap
description: Leaders want simplicity. The front line wants simplicity. So why is it so hard to actually get any?
date: 2026-09-13
tags:
  - product management
  - strategy
...
The trouble is that putting dates against things involves predicting the future. Which, however much we all agree to pretend otherwise, is impossible. ([Basecamp](https://basecamp.com/shapeup/2.1-chapter-07) are blunter about this than most.)
...
I’ve written before about [picking the right problems to solve](https://liamnugent.me/posts/picking-the-right-problems/), and about checking each one against the strategy before you go anywhere near it. What that post quietly assumed was that a strategy existed to be checked against.
...
That’s an idea I’ve nicked from [Luke Wroblewski](https://lukew.com/ff/entry.asp?854=), who writes about design principles needing to be specific enough that people can actually choose between options with them. “Make it easy to use” is a uselessly broad design principle. It is a surprisingly good test for a strategy.
