---
title: Keep the show on the road
description: Build is only the first part of the product lifecycle. It’s also where most product people live, work and get stuck.
date: 2026-09-21
tags:
  - product management
  - strategy
...
Products and features exist to try to create or influence an [outcome](https://liamnugent.me/posts/product-management-101/).
...
<svg viewBox="0 0 470 210" role="img" aria-labelledby="lifecycle-title lifecycle-desc" style="width: 100%; height: auto; max-width: 470px;">
  <title id="lifecycle-title">The product lifecycle, honestly proportioned</title>
  <desc id="lifecycle-desc">A timeline. A short box labelled Build leads by an arrow to a much longer box labelled Operate, which leads by an arrow to the word Retired. Above the Operate box a loop arrow is labelled “Persevere or pivot?”, repeating for as long as the product is operated. A note beneath the Build box reads “where most of us live and get stuck”.</desc>
  <g fill="none" stroke="currentColor" stroke-width="1.5">
    <rect x="20" y="105" width="85" height="48"/>
    <rect x="140" y="105" width="215" height="48"/>
    <line x1="105" y1="129" x2="133" y2="129"/>
    <line x1="355" y1="129" x2="383" y2="129"/>
    <path d="M330 100 C330 68, 165 68, 165 98"/>
  </g>
  <g fill="currentColor" stroke="none">
    <polygon points="133,129 125,125 125,133"/>
    <polygon points="383,129 375,125 375,133"/>
    <polygon points="165,102 161,92 169,92"/>
  </g>
  <g fill="currentColor" font-family="Georgia, serif" font-size="15" text-anchor="middle">
    <text x="62" y="134">Build</text>
    <text x="247" y="134">Operate</text>
    <text x="420" y="134" font-style="italic">Retired</text>
    <text x="247" y="58" font-style="italic">Persevere or pivot?</text>
  </g>
  <g fill="currentColor" font-family="Georgia, serif" font-size="12" text-anchor="middle" opacity="0.75">
    <text x="62" y="176">where most of us</text>
...
Then you keep asking it, until the product is retired. It’s a close relative of the question [Jason Fried asks about anything he’s finished](https://liamnugent.me/posts/would-i-do-it-again/) — would I do it again? Same instinct. You’re just asking it about something that’s still running.
...
Because… entropy. [I’ve been here before on this very site](https://liamnugent.me/posts/the-auditors-are-in/) — 100/100 across the board when I launched it, and then the scores quietly dropped without anything being consciously changed by me.
...
And neglect sends you a bill eventually. It once took me [four hours to get back to the position where I could write a post](https://liamnugent.me/posts/upgrading-to-eleventy-v1-on-netlify/). That’s on a personal site with one user and nothing at stake.
